"""
This modul provides an example of converting the data from the Waymo Open Dataset into the tf record format used by the Tensorflow Object Detection API.
"""
